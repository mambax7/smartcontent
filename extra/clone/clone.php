...
$patterns = array(
  ...
  'smartcontent'  => 'mysection',
  'SMARTCONTENT'  => 'MYSECTION',
  'SmartContent'  => 'MySection',
  'Smart Content' => 'My Section',
  'SCONTENT'      => 'MSECTION',
  'Smartcontent'  => 'Mysection'
);
...
cloneFileFolder('modules/smartcontent');

echo "Happy cloning...\n";
echo "check directory modules/" . $patterns['smartcontent'] . " for cloned module \n";
